...
TimingPresets = {
	...
	["DDR Modern"] = {
		TimingWindowSecondsW1   = 0.017,
		TimingWindowSecondsW2   = 0.034,
		TimingWindowSecondsW3   = 0.084,
		TimingWindowSecondsW4   = 0.124,
		TimingWindowSecondsW5   = 0.124, -- matches W4; Way Off effectively disabled
		TimingWindowSecondsHold = 0.300,
		TimingWindowSecondsMine = 0.034,
